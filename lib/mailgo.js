...
var openWhatsApp = function openWhatsApp(event) {
  event.preventDefault(); // WhatsApp API doesn't work with non number digits: https://faq.whatsapp.com/general/chats/how-to-use-click-to-chat/

  var whatsappRegex = new RegExp("[^0-9/]", "gi"); // replace them

  var whatappTel = tel.replace(whatsappRegex, "");
  console.log(whatappTel); // WhatsApp url
