...
var mailgoInit = function mailgoInit() {
  ...
  if (!mailgoTelExists) {
    var _config5, _config6, _config7;
    ...
    if (typeof ((_config6 = config) === null || _config6 === void 0 ? void 0 : _config6.showFooter) === "undefined" || ((_config7 = config) === null || _config7 === void 0 ? void 0 : _config7.showFooter) !== false) {
...
function mailgoRender() {
  ...
  if (type === MAIL_TYPE) {
    ...
    if (typeof ((_config8 = config) === null || _config8 === void 0 ? void 0 : _config8.validateEmail) !== "undefined") {
    ...
    copyMail.addEventListener("click", function (event) {
      ...
      if (typeof ((_config9 = config) === null || _config9 === void 0 ? void 0 : _config9.validateTel) !== "undefined") {
  ...
  if (!((_config10 = config) === null || _config10 === void 0 ? void 0 : _config10.dark)) {
