...
var _ref = i18n,
    translations = _ref.translations; // default strings

var defaultStrings = translations[DEFAULT_LANG]; // translation strings
...
var mailgoActionEnabled = function mailgoActionEnabled(action) {
  ...
  if (config && !((_config9 = config) === null || _config9 === void 0 ? void 0 : _config9.actions)) return true;
  if (config && config.actions && ((_config10 = config) === null || _config10 === void 0 ? void 0 : _config10.actions[action]) === false) return false;
  return true;
};
...
function mailgo(mailgoConfig) {
  ...
  if (window && typeof window !== "undefined") {
    var _config11, _config12, _config13, _config14;
    ...
    if (((_config12 = config) === null || _config12 === void 0 ? void 0 : _config12.lang) && i18n.languages.indexOf(config.lang) !== -1) {
      lang = config.lang;
    } // if is defined <html lang=""> use it!


    if (!((_config13 = config) === null || _config13 === void 0 ? void 0 : _config13.forceLang)) {
    ...
    if ((_config14 = config) === null || _config14 === void 0 ? void 0 : _config14.initEvent) {
      var _config15;

      if ((_config15 = config) === null || _config15 === void 0 ? void 0 : _config15.listenerOptions) {
