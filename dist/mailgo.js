...
var mailgoSetLanguage = function mailgoSetLanguage() {
  ...
  if ((_config12 = config) !== null && _config12 !== void 0 && _config12.lang && languages_namespaceObject.indexOf(config.lang) !== -1) {
    lang = config.lang;
...
function mailgo(mailgoConfig) {
  try {
    ...
    if (typeof window !== "undefined") {
      ...
      if ((_config17 = config) !== null && _config17 !== void 0 && _config17.initEvent) {
        var _config18;

        if ((_config18 = config) !== null && _config18 !== void 0 && _config18.listenerOptions) {
